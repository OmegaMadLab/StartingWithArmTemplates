...
- **07_TemplateScripts_WhatIf**: a couple of examples about the [What-If](https://docs.microsoft.com/en-us/azure/azure-resource-manager/templates/template-deploy-what-if?WT.mc_id=AZ-MVP-5003770) deployment feature, to preview the changes you're applying with the deployment, and the [DeploymentScript](https://docs.microsoft.com/en-us/azure/azure-resource-manager/templates/deployment-script-template?WT.mc_id=AZ-MVP-5003770) resouce.
- **08_ARM_TTK**: a quick sample of how to install and use the [ARM Template Toolkit](https://github.com/Azure/arm-ttk).
- **09_TemplateSpecs**: a quick sample about using the [TemplateSpec](https://docs.microsoft.com/en-us/azure/azure-resource-manager/templates/template-specs?WT.mc_id=AZ-MVP-5003770) preview feature.
